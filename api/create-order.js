...
module.exports = async function handler(req, res) {
  ...
  if (!keyId || !keySecret) {
    return res.status(500).json({ error: 'Payment gateway not configured. Set RAZORPAY_KEY_ID and RAZORPAY_KEY_SECRET in Vercel environment variables.' });
  }
